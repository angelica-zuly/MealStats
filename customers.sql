...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 28, 2020 at 07:19 PM
...
CREATE TABLE `orders` (
  ...
  `order_items` varchar(1000) COLLATE utf8_unicode_ci NOT NULL,
  `order_name` varchar(16) COLLATE utf8_unicode_ci NOT NULL,
...
('MealStats Worker', 'worker@mealstats.com', 'worker123');
COMMIT;
